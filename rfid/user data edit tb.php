...
<html>
	<head>
		...
		<title>Edit: Changes Saved!</title>
	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2; background-color: teal; border-radius: 14px; margin-top: 55px;">
				<div class="row">
